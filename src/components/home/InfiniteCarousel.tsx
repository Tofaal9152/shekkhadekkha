...
const images = [
  ...
  // "https://plus.unsplash.com/premium_photo-1667734613410-aebe970c3f60?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8dmVydGljYWx8ZW58MHx8MHx8fDA%3D",
  "/instructors/instructorImg3.png",
  "/instructors/instructorImg3.png",
  "/instructors/instructorImg3.png",
  "/instructors/instructorImg3.png",
  // "/instructors/instructorImg1.jpg",
...
const InfiniteCarousel = () => {
  return (
    <div className="relative overflow-hidden h-[93vh] w-full max-w-xl">
      ...
      <div className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-b from-slate-100 dark:from-slate-950 to-transparent z-10"></div>
      <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-slate-100 dark:from-slate-950 to-transparent z-10"></div>
